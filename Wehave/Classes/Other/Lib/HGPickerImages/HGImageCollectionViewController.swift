...
class HGImageCollectionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //添加导航栏右侧的取消按钮
        let rightBarItem = UIBarButtonItem(title: "Cancelar", style: .plain,
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        if let cell = collectionView.cellForItem(at: indexPath)
            ...
            if count > self.maxSelected {
                ...
                //弹出提示
                let title = "Se puede Elija \(self.maxSelected)fotos como maximo"
                let alertController = UIAlertController(title: title, message: nil,
                                                        preferredStyle: .alert)
                
                let cancelAction = UIAlertAction(title:"De acuerdo", style: .cancel,
                                                 handler:nil)
