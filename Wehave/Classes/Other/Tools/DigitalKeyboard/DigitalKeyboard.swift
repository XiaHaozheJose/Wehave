...
import UIKit
 ...
 let defaultDoneColor = UIColor(red: 28 / 255, green: 171 / 255, blue: 235 / 255, alpha: 1)
...
public class DigitalKeyboard: UIInputView, UITextFieldDelegate {
    ...
    public func customDoneButton(title: String, titleColor: UIColor = UIColor.white, theme: UIColor = UIColor.lightText, target: UIViewController? = nil, callback: Selector? = nil) {
