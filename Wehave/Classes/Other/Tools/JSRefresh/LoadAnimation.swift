...
//  SRide
//
//  Created by JS_Coder on 2018/5/20.
//  Copyright © 2018年 JS_Coder. All rights reserved.
//

import UIKit
class JSLoadingView: UIView {
    
    public var lineWidth: Int = 2  //线的宽度  默认为2
    
    public var lineColor: UIColor = ThemeColor //线的颜色  默认是红色
    ...
    override init(frame: CGRect) {
        ...
        self.timer = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(JSLoadingView.updateLoading), userInfo: nil, repeats: true)  //创建计时器
